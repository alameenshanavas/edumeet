                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Text("Subject"),
                          Text("Chemistry",style: TextStyle(fontWeight: FontWeight.bold),)
                        ],
                      ),
                      Column(
                        children: [
                          Text("Teacher"),
                          Text("Athul A",style: TextStyle(fontWeight: FontWeight.bold),)
                        ],
                      )
                    ],
                  ),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text("Room7",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)
                ],
              ),
            ),
